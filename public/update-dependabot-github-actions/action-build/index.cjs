    ...
    '../../node_modules/.pnpm/@actions+http-client@2.1.1/node_modules/@actions/http-client/lib/auth.js'(exports) {
        ...
        var BasicCredentialHandler = class {
            ...
            prepareRequest(options2) {
                ...
                options2.headers['Authorization'] = `Basic ${Buffer.from(`${this.username}:${this.password}`).toString(
                    'base64',
                )}`;
            }
...
var require_core = __commonJS({
    '../../node_modules/.pnpm/@actions+core@1.10.1/node_modules/@actions/core/lib/core.js'(exports) {
        ...
        function getMultilineInput(name, options2) {
            const inputs = getInput2(name, options2)
                .split('\n')
                .filter((x) => x !== '');
            if (options2 && options2.trimWhitespace === false) {
                return inputs;
...
var require_nopt_lib = __commonJS({
    '../../node_modules/.pnpm/nopt@7.2.0/node_modules/nopt/lib/nopt-lib.js'(exports, module2) {
        ...
        function nopt2(args, { types: types2, shorthands, typeDefs, invalidHandler, typeDefault, dynamicTypes } = {}) {
        ...
        function clean(data, { types: types2 = {}, typeDefs = {}, dynamicTypes, invalidHandler, typeDefault } = {}) {
        ...
        function parse2(args, data, remain, { types: types2 = {}, typeDefs = {}, shorthands = {}, dynamicTypes } = {}) {
            const StringType = typeDefs.String?.type;
            const NumberType = typeDefs.Number?.type;
            const ArrayType = typeDefs.Array?.type;
            const BooleanType = typeDefs.Boolean?.type;
...
var require_Collection = __commonJS({
    '../../node_modules/.pnpm/yaml@2.3.2/node_modules/yaml/dist/nodes/Collection.js'(exports) {
        ...
        var isEmptyPath = (path5) =>
            path5 == null || (typeof path5 === 'object' && !!path5[Symbol.iterator]().next().done);
...
var require_addPairToJSMap = __commonJS({
    '../../node_modules/.pnpm/yaml@2.3.2/node_modules/yaml/dist/nodes/addPairToJSMap.js'(exports) {
        ...
        var isMergeKey = (key) =>
            key === MERGE_KEY ||
            (identity.isScalar(key) && key.value === MERGE_KEY && (!key.type || key.type === Scalar.Scalar.PLAIN));
...
var require_Document = __commonJS({
    '../../node_modules/.pnpm/yaml@2.3.2/node_modules/yaml/dist/doc/Document.js'(exports) {
        ...
        var Document2 = class _Document {
             ...
             */
            hasIn(path5) {
                if (Collection.isEmptyPath(path5)) return this.contents !== void 0;
            ...
            setSchema(version2, options2 = {}) {
                ...
                if (options2.schema instanceof Object) this.schema = options2.schema;
                else if (opt) this.schema = new Schema.Schema(Object.assign(opt, options2));
            ...
            for (const collItem of bm.items) {
                ...
                if (valueProps.found) {
                    ...
                    const valueNode = value
                        ...
                        : composeEmptyNode(ctx, offset, sep2, null, valueProps, onError);
                ...
                for (const token of end) {
                    ...
                    switch (type) {
                        ...
                        case 'comment': {
                            ...
                            if (!comment) comment = cb;
                            else comment += sep2 + cb;
                            sep2 = '';
                            break;
                        }
                        case 'newline':
                            if (comment) sep2 += source;
                            hasSpace = true;
                            break;
                        default:
        ...
        function resolveFlowCollection({ composeNode, composeEmptyNode }, ctx, fc, onError, tag) {
            ...
            for (let i = 0; i < fc.items.length; ++i) {
                ...
                if (!isMap && !sep2 && !props.found) {
                    const valueNode = value
                        ? composeNode(ctx, value, props, onError)
                        : composeEmptyNode(ctx, props.end, sep2, null, props, onError);
                    ...
                    const valueNode = value
                        ? composeNode(ctx, value, valueProps, onError)
                        : valueProps.found
                        ? composeEmptyNode(ctx, valueProps.end, sep2, null, valueProps, onError)
                        : null;
                    if (valueNode) {
                        if (isBlock(value)) onError(valueNode.range, 'BLOCK_IN_FLOW', blockMsg);
...
var require_compose_scalar = __commonJS({
    '../../node_modules/.pnpm/yaml@2.3.2/node_modules/yaml/dist/compose/compose-scalar.js'(exports) {
        ...
        function findScalarTagByTest({ directives, schema }, value, token, onError) {
            ...
            if (schema.compat) {
                const compat =
                    schema.compat.find((tag2) => tag2.default && tag2.test?.test(value)) ?? schema[identity.SCALAR];
...
var require_cst_stringify = __commonJS({
    '../../node_modules/.pnpm/yaml@2.3.2/node_modules/yaml/dist/parse/cst-stringify.js'(exports) {
        ...
        function stringifyItem({ start, key, sep: sep2, value }) {
            ...
            if (sep2) for (const st of sep2) res += st.source;
            ...
            *flowCollection(fc) {
                ...
                if (this.type === 'flow-error-end') {
                    ...
                    switch (this.type) {
                        ...
                        case 'double-quoted-scalar': {
                            const fs3 = this.flowScalar(this.type);
                            if (!it || it.value) fc.items.push({ start: [], key: fs3, sep: [] });
                            else if (it.sep) this.stack.push(fs3);
                            else Object.assign(it, { key: fs3, sep: [] });
                            return;
                        }
                        case 'flow-map-end':
                        case 'flow-seq-end':
...
var require_public_api = __commonJS({
    '../../node_modules/.pnpm/yaml@2.3.2/node_modules/yaml/dist/public-api.js'(exports) {
        ...
        function stringify2(value, replacer, options2) {
            ...
            if (typeof options2 === 'string') options2 = options2.length;
...
var AST = class _AST {
    ...
    toMMPattern() {
        ...
        const anyMagic =
            hasMagic2 ||
            this.#hasMagic ||
            (this.#options.nocase && !this.#options.nocaseMagicOnly && glob2.toUpperCase() !== glob2.toLowerCase());
        if (!anyMagic) {
            return body;
        }
    ...
    toRegExpSource(allowDot) {
        ...
        if (!this.type) {
            ...
            return [final2, unescape2(src), (this.#hasMagic = !!this.#hasMagic), this.#uflag];
        }
        ...
        return [final, unescape2(body), (this.#hasMagic = !!this.#hasMagic), this.#uflag];
    }
    #partsToRegExp(dot) {
        return this.#parts
            .map((p) => {
...
var Minimatch = class {
    ...
    constructor(pattern, options2 = {}) {
        ...
        this.windowsNoMagicRoot =
            options2.windowsNoMagicRoot !== void 0 ? options2.windowsNoMagicRoot : !!(this.isWindows && this.nocase);
        this.globSet = [];
        this.globParts = [];
        this.set = [];
        this.make();
...
var LRUCache = class _LRUCache {
    ...
    *rvalues() {
    ...
    #backgroundFetch(k, index, options2, context) {
        ...
        const cb = (v2, updateCache = false) => {
            ...
            if (options2.status) {
                if (aborted && !updateCache) {
                    ...
                    if (ignoreAbort) options2.status.fetchAbortIgnored = true;
                } else {
            ...
            if (this.#valList[index] === p) {
                if (v2 === void 0) {
                    ...
                    if (options2.status) options2.status.fetchUpdated = true;
        ...
        if (options2.status) options2.status.fetchDispatched = true;
    ...
    #isBackgroundFetch(p) {
        ...
        const b = p;
        return (
            !!b && b instanceof Promise && b.hasOwnProperty('__staleWhileFetching') && b.__abortController instanceof AC
        );
    }
...
var isStream = (s) =>
    !!s &&
    typeof s === 'object' &&
    (s instanceof Minipass || s instanceof import_stream.default || isReadable(s) || isWritable(s));
var isReadable = (s) =>
    !!s &&
    typeof s === 'object' &&
    s instanceof import_events.EventEmitter &&
...
var isArrayBufferLike = (b) =>
    ...
    (!!b && typeof b === 'object' && b.constructor && b.constructor.name === 'ArrayBuffer' && b.byteLength >= 0);
...
var PathScurryBase = class {
    ...
    constructor(
        ...
        pathImpl,
        sep2,
        { nocase, childrenCacheSize = 16 * 1024, fs: fs3 = defaultFS } = {},
    ) {
    ...
    *iterateSync(entry = this.cwd, opts = {}) {
    ...
    streamSync(entry = this.cwd, opts = {}) {
        ...
        const process2 = () => {
            ...
            if (paused && !results.flowing) results.once('drain', process2);
        };
        process2();
        return results;
    }
...
var PathScurry =
    process.platform === 'win32' ? PathScurryWin32 : process.platform === 'darwin' ? PathScurryDarwin : PathScurryPosix;
...
var Pattern = class _Pattern {
    ...
    isAbsolute() {
        const pl = this.#patternList;
        return this.#isAbsolute !== void 0
            ? this.#isAbsolute
            : (this.#isAbsolute = (pl[0] === '' && pl.length > 1) || this.isDrive() || this.isUNC());
    }
    /**
...
var defaultPlatform2 =
    typeof process === 'object' && process && typeof process.platform === 'string' ? process.platform : 'linux';
var Ignore = class {
    relative;
    relativeChildren;
    absolute;
...
var MatchRecord = class {
    ...
    entries() {
        return [...this.store.entries()].map(([path5, n]) => [path5, !!(n & 2), !!(n & 1)]);
    }
};
var SubWalks = class {
    store = /* @__PURE__ */ new Map();
...
var Processor = class _Processor {
    ...
    testGlobstar(e, pattern, rest, absolute) {
        ...
        if (rest) {
            const rp = rest.pattern();
            if (
                typeof rp === 'string' && // dots and empty were handled already
                rp !== '..' &&
                rp !== '' &&
                rp !== '.'
            ) {
...
var makeIgnore = (ignore, opts) =>
    typeof ignore === 'string' ? new Ignore([ignore], opts) : Array.isArray(ignore) ? new Ignore(ignore, opts) : ignore;
var GlobUtil = class {
    path;
    patterns;
    opts;
...
var hasMagic = (pattern, options2 = {}) => {
    ...
    for (const p of pattern) {
        if (new Minimatch(p, options2).hasMagic()) return true;
    }
    return false;
};
...
async function findDependabotFile(dependabotFile, cwd) {
    if (dependabotFile) return path3.resolve(cwd, dependabotFile);
...
function normalizeActionsToFolders(actions, cwd) {
    const rel = actions
        .map((p) => path3.relative(cwd, p))
        .map((p) => path3.dirname(p))
